...
from archs_unstructured.ops import OPS, DropPath_, ZeroLayer
...
class _SampleLayer(nn.Module):
    ...
    def __init__(
        ...
        self.nonlinear = nn.LayerChoice([nn.Identity(), LearnableAlpha(inplanes, fea_size)])
...
class SampleBlock(nn.ModuleDict):
    def __init__(
        ...
        for i in range(num_layers):
            ...
            layer = _SampleLayer(inplanes * 2, 'sampleunit', fea_size)
...
class AggregateBlock(nn.Module):
    def __init__(
        ...
        self.nonlinear = nn.Sequential(
            ...
            LearnableAlpha(outplanes, fea_size)
        )
    ...
    def __init__(
        ...
        for i, num_layers in enumerate(block_config):
            ...
            if i != len(block_config) - 1:
                ...
                trans = AggregateBlock(channels, num_features, fea_size=int(fs[i]/2))
